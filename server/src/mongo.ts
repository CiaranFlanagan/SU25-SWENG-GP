  ...
  await GameModel.insertMany([
    {
      ...
      players: [user2, user3],
      history: [
        { when: new Date('2025-04-21T10:00:00Z'), by: user2._id, move: 3 },
        { when: new Date('2025-04-21T10:01:00Z'), by: user3._id, move: 5 },
        { when: new Date('2025-04-21T10:02:00Z'), by: user2._id, move: 7 },
        { when: new Date('2025-04-21T10:03:00Z'), by: user3._id, move: 6 },
      ],
    ...
    {
      type: 'guess',
      state: { secret: 43, guesses: [25, 2, 99, 67] },
      done: true,
      chat: (await createChat(daysAgo(0.2)))._id,
      players: [user1, user0, user3, user2],
      history: [
        { when: daysAgo(0.19), by: user1._id, move: 25 },
        { when: daysAgo(0.18), by: user0._id, move: 2 },
        { when: daysAgo(0.17), by: user3._id, move: 99 },
        { when: daysAgo(0.16), by: user2._id, move: 67 },
      ],
